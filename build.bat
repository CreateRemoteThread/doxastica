...
IF [%1]==[shackle64] cl /O2 /Zi /c /EHsc /I lua53 /Fosearch64.obj /Tp search.c
IF [%1]==[shackle64] cl /O2 /Zi /c /EHsc /I lua53 /Fopcontrol64.obj /Tp pcontrol.c
IF [%1]==[shackle64] cl /D ARCHI_64 /O2 /Zi /c /I lua53 /I beainclude /EHsc /Foshackle64.obj /Tp shackle.c
IF [%1]==[shackle64] link /DLL /OPT:REF /OPT:ICF /INCREMENTAL:NO /DEBUG /out:shackle64.dll shackle64.obj ptrscan64.obj beasrc/BeaEngine64.obj lua64/*.obj user32.lib psapi.lib xed64/*.obj search64.obj pcontrol64.obj xedparse/xed2/lib/libxed_x64.lib imagehlp.lib

IF [%1]==[shackle32] cl /O2 /Zi /c /I lua53 /EHsc /Foptrscan32.obj /Tp ptrscan.c
IF [%1]==[shackle32] cl /O2 /Zi /c /EHsc /I lua53 /Fosearch32.obj /Tp search.c
IF [%1]==[shackle32] cl /O2 /Zi /c /EHsc /I lua53 /Fopcontrol32.obj /Tp pcontrol.c
IF [%1]==[shackle32] cl /O2 /Zi /c /I lua53 /I beainclude /EHsc /Foshackle32.obj /Tp shackle.c
IF [%1]==[shackle32] link /DLL /OPT:REF /OPT:ICF /INCREMENTAL:NO /DEBUG /out:shackle32.dll shackle32.obj ptrscan32.obj beasrc/BeaEngine32.obj lua32/*.obj user32.lib psapi.lib xed32/*.obj search32.obj pcontrol32.obj xedparse/xed2/lib/libxed_x86.lib imagehlp.lib
